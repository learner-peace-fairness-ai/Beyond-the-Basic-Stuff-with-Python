...
tip_jar = WizCoin(0, 0, 37)  # 別の WizCoin オブジェクトを生成する

print(purse.total, tip_jar.total)  # クヌート単位で合計金額を得る

print(purse > tip_jar)

print(purse < tip_jar)

print(purse > 1000)  # int との比較

print(purse <= 1000)

print(purse == 1141)

print(purse == 1141.0)  # float との比較

print(purse == "1141")  # WizCoin はどんな文字列とも等しくない

bag_of_Knuts = WizCoin(0, 0, 1141)
print(purse == bag_of_Knuts)

print(purse == (2, 5, 10))  # 3つの整数のタプルと比較できる

print(purse == [2, 5, 10])  # 3つの整数のリストと比較できる

print(purse >= ["cat", "dog"])  # これはエラーを発生させるべき
