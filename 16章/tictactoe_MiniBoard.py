# tictactoe_MiniBoard.py, オブジェクト指向バージョンの三目並べゲーム
...
def main():
    ...
    print("三目並べゲームだよ！")
    # 盤面オブジェクトを生成する
    if input("縮小版の盤面表示を使いますか？ Y/N: ").lower().startswith("y"):
        game_board = MiniBoard()  # MiniBoard のオブジェクトを生成
    else:
        game_board = TTTBoard()   #  TTTBoard のオブジェクトを生成
